...
class TripDetailsPhone extends StatefulWidget {
  @override
  _TripDetailsPhoneState createState() => _TripDetailsPhoneState();
}

class _TripDetailsPhoneState extends State<TripDetailsPhone> {
            ...
            body: CustomScrollView(
              ...
              slivers: <Widget>[
                ...
                sizingInformation.deviceScreenType == DeviceScreenType.Mobile
                    ? getIncludedAppBarPhone(context)
